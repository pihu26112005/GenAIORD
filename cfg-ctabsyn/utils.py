...
def get_args():
    ...
    parser.add_argument('--condition_by', type=int, default=0, help='Condition by: 0, 1, or 2.')
    parser.add_argument('--n_classes', type=int, default=3, help='Number of classes (2 or 3).')
