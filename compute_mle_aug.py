...
try:
    ...
    synth_ord_minority = pd.read_csv(f'data/{DATANAME}/synthetic/synthetic_minority_cfg.csv')
    ...
    print(f"Skipping ORD evaluation: Could not find data/{DATANAME}/synthetic/synthetic_minority_cfg.csv")
